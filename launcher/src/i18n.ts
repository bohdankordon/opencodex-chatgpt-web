...
const en = {
  ...
  stepInstallBody: "Install the ChatGPT Web bridge for Codex. A Direct install manages the Codex route and restores the previous route when removed; an external-provider install leaves Codex routing to your external router.",
  ...
  reinstall: "Reinstall",
  routingTitle: "Codex routing",
  routingDirect: "Direct",
  routingDirectBody: "The Launcher installs and manages the Codex route. Selected by default.",
  routingExternal: "External provider/router",
  routingExternalBody: "The Launcher manages only the ChatGPT Web bridge. Codex routing stays owned by your external router (for example OpenCodex): the Launcher does not install, register, or configure that router. Point Codex at the router and release the route to it before installing, or External setup will fail.",
  ...
  mcpCatalogRequired: "Connect harness is unavailable until the bridge is installed and ready. Return to Setup and complete Install models first.",
  tunnelId: "Tunnel ID",
  ...
  uninstallIntegrationBody: "Remove the private bridge runtime. A Direct Codex route owned by this installation is restored; external router configuration is left untouched.",
  integrationRemoved: "Integration removed. Restart Codex only if the Launcher reports it is required.",
  running: "Running",
  complete: "Complete",
  failed: "Failed",
  healthy: "Healthy",
...
const zh: Record<keyof typeof en, string> = {
  ...
  stepInstallBody: "为 Codex 安装 ChatGPT Web bridge。Direct 安装会管理 Codex 路由，并在移除时恢复此前的路由；external-provider 安装将 Codex 路由交由外部路由器管理。",
  ...
  install: "安装模型",
  reinstall: "重新安装",
  routingTitle: "Codex 路由",
  routingDirect: "Direct",
  routingDirectBody: "由启动器安装并管理 Codex 路由。默认选中。",
  routingExternal: "外部 Provider/路由器",
  routingExternalBody: "启动器仅管理 ChatGPT Web bridge。Codex 路由仍归外部路由器所有（例如 OpenCodex）：启动器不会安装、注册或配置该路由器。请先将 Codex 指向该路由器并释放路由，否则外部安装将失败。",
  ...
  mcpCatalogRequired: "在 bridge 安装就绪之前无法连接 Harness。请先返回“设置”完成“安装模型”。",
  tunnelId: "Tunnel ID",
  ...
  uninstallIntegrationBody: "移除私有 bridge 运行时。此安装拥有的 Direct Codex 路由将被恢复；外部路由器配置保持不变。",
  integrationRemoved: "集成已移除。仅在启动器提示需要时重启 Codex。",
  running: "运行中",
  complete: "完成",
  failed: "失败",
  healthy: "健康",
...
const ja: Record<keyof typeof en, string> = {
  ...
  stepInstallBody: "Codex 用の ChatGPT Web ブリッジをインストールします。Direct インストールでは Codex ルートを管理し、削除時に以前のルートを復元します。external-provider インストールでは Codex ルーティングは外部ルーターに委ねられます。",
  ...
  install: "モデルをインストール",
  reinstall: "再インストール",
  routingTitle: "Codex ルーティング",
  routingDirect: "Direct",
  routingDirectBody: "ランチャーが Codex ルートをインストールして管理します。デフォルトで選択されています。",
  routingExternal: "外部プロバイダー/ルーター",
  routingExternalBody: "ランチャーが管理するのは ChatGPT Web ブリッジのみです。Codex ルーティングは外部ルーター（例: OpenCodex）が所有し続けます。ランチャーはそのルーターをインストール・登録・設定しません。インストール前に Codex をルーターに向けてルートを解放してください。解放されていない場合、外部セットアップは失敗します。",
  ...
  mcpCatalogRequired: "ブリッジのインストールが完了するまでハーネスを接続できません。セットアップに戻り、まずモデルのインストールを完了してください。",
  tunnelId: "Tunnel ID",
  ...
  uninstallIntegrationBody: "非公開ブリッジランタイムを削除します。このインストールが所有する Direct Codex ルートは復元されます。外部ルーターの設定は変更されません。",
  integrationRemoved: "統合を削除しました。ランチャーが求めた場合のみ Codex を再起動してください。",
  running: "実行中",
  complete: "完了",
  failed: "失敗",
  healthy: "正常",
...
const ko: Record<keyof typeof en, string> = {
  ...
  stepInstallBody: "Codex용 ChatGPT Web 브리지를 설치합니다. Direct 설치는 Codex 경로를 관리하고 제거 시 이전 경로를 복원합니다. external-provider 설치에서는 Codex 라우팅이 외부 라우터에 위임됩니다.",
  ...
  install: "모델 설치",
  reinstall: "다시 설치",
  routingTitle: "Codex 라우팅",
  routingDirect: "Direct",
  routingDirectBody: "런처가 Codex 경로를 설치하고 관리합니다. 기본값으로 선택됩니다.",
  routingExternal: "외부 공급자/라우터",
  routingExternalBody: "런처는 ChatGPT Web 브리지만 관리합니다. Codex 라우팅은 외부 라우터(예: OpenCodex)가 계속 소유합니다. 런처는 해당 라우터를 설치·등록·구성하지 않습니다. 설치하기 전에 Codex를 라우터에 연결하고 경로를 해제하세요. 그렇지 않으면 외부 설치가 실패합니다.",
  ...
  mcpCatalogRequired: "브리지가 설치되고 준비될 때까지 하네스를 연결할 수 없습니다. 설정으로 돌아가 먼저 모델 설치를 완료하세요.",
  tunnelId: "Tunnel ID",
  ...
  uninstallIntegrationBody: "비공개 브리지 런타임을 제거합니다. 이 설치가 소유한 Direct Codex 경로는 복원되며, 외부 라우터 구성은 그대로 유지됩니다.",
  integrationRemoved: "통합이 제거되었습니다. 런처가 요청한 경우에만 Codex를 다시 시작하세요.",
  running: "실행 중",
  complete: "완료",
  failed: "실패",
  healthy: "정상",
...
const zhTW: Record<keyof typeof en, string> = {
  ...
  stepInstallBody: "為 Codex 安裝 ChatGPT Web bridge。Direct 安裝會管理 Codex 路由，並在移除時還原先前的路由；external-provider 安裝將 Codex 路由交由外部路由器管理。",
  ...
  routingTitle: "Codex 路由",
  routingDirect: "Direct",
  routingDirectBody: "由啟動器安裝並管理 Codex 路由。預設選中。",
  routingExternal: "外部 Provider/路由器",
  routingExternalBody: "啟動器僅管理 ChatGPT Web bridge。Codex 路由仍歸外部路由器所有（例如 OpenCodex）：啟動器不會安裝、註冊或設定該路由器。請先將 Codex 指向該路由器並釋放路由，否則外部安裝將失敗。",
  ...
  mcpCatalogRequired: "在 bridge 安裝就緒之前無法連線 Harness。請先返回「設定」完成「安裝模型」。",
  tunnelId: "Tunnel ID",
  runtimeKey: "API key（不是 Admin key）",
  connect: "連線 Harness",
  ...
  uninstallIntegrationBody: "移除私人 bridge 執行階段。此安裝擁有的 Direct Codex 路由將被還原；外部路由器設定保持不變。",
  integrationRemoved: "整合已移除。僅在啟動器提示需要時重新啟動 Codex。",
  running: "執行中",
  complete: "完成",
  failed: "失敗",
  healthy: "健康",
